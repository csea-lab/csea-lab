% ECG2HRchange
function [CON_BPMmat, BPMavgmat8cond_bsl] = HR2HRchangeZurich2016(csvfiledata, csvfilejournal)
...
while line ~= -1; 
    ...
    line(commaindices(3)+1:commaindices(4)-1)
    ...
    %conditionword = line(commaindices(6)+1:apoindices(end)-1); disp('label word:'), disp(conditionword(1:end-1))
