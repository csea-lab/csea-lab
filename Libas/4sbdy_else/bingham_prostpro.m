function [ERP_happy, ERP_angry, ERP_sad, stats_amp, stats_SNR] =  bingham_prostpro (datapath, conditionflag)
...
subplot(1,3,3), plot(freqs(1:160), ampsad(15:17, 1:160),'b', 'LineWidth',1); xline(15, 'k', {'Face'}, 'LineWidth', 1), xline(12, 'k-.', {'Gabor'}, 'LineWidth', 1);
...
subplot(1,3,2), plot(freqs(1:160), ampangry(15:17, 1:160), 'r', 'LineWidth',1); xline(15, 'k', 'Gabor', 'LineWidth', 1), xline(12, '-.', 'Face', 'LineWidth', 1);
axis([0 freqs(160) 0 yscale]), title('angry'), xlabel('Frequency (Hz)')
subplot(1,3,3), plot(freqs(1:160), ampsad(15:17, 1:160),'b', 'LineWidth',1); xline(15, 'k', 'Gabor', 'LineWidth', 1), xline(12, '-.', 'Face', 'LineWidth', 1);
axis([0 freqs(160) 0 yscale]), title('sad')
xlabel(datapath(1:15))    
end        
