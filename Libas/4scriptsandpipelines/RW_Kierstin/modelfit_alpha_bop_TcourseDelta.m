...
function [] = modelfit_alpha_bop_TcourseDelta(appmatfilemat, igfilemat)
...
for fileindex = 1:size(igfilemat,1)
    ...
    % load each person's data
      ...
      % !!!!!!  
       %aaaaaahh turn on for bsl corrected
          alpha3d_Welch = alphapowertrial;
       % alpha3d_Welch = bslcorrWAMat_div(alphapowertrial, 1400:1700); 
