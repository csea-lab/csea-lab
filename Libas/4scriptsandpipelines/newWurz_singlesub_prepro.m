...
for subindex = 1:size(folderNames,2)
   ...
   prepro_scadsandspline_log(rawfile, datfile, 'getCon_NewWurz2trigs', 12, {'1' '2' '3' '4' '5'}, [-.8 7], [3  32], [4  9], 3, 'GSN-HydroCel-128.sfp', 'HC1-128.ecfg');
   prepro_scadsandspline_log(rawfile, datfile, 'getCon_NewWurz2trigs', 12, {'11' '12' '13' '14' '15' }, [9 .8], [3  32], [4  9], 3, 'GSN-HydroCel-128.sfp', 'HC1-128.ecfg');
