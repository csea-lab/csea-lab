...
% for mat files: flip sensor config (see below) !!!!!!!!
for file = 1:size(filemat,1);
[diploc, lfdmat, data, G, invsol] = invmap_reduce_mat(lfd_mat, dipoles_symmetric, 0.01, pwd, 'condispas_325.fl32h3.E1.app11.mat' , pwd, [], elek129HCLnorm', 1, 1301, 'abs', 50:150);
end
