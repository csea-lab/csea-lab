function [condvec, picvec, statvec_aro, statvec_val] = getcon_MyAPSLPP(filepath)
condvec = []; 
picvec = [];
trialnums  = []; 
unparsedratings = []; 
...
trialindex = 1
 ...
 p = [4534 2045 8500 2300 2314 2540 2373 4001 2550 2600 4628 4597 7502 4150 4505 4574 5910 7405 7451 7481]

 u = [1270 1390 1205 2092 2901 3016 2110 6211 6510 6940 3101 9001 9010 9140 9570 9300 9630 9900 9905 9909] 
