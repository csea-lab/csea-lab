...
for index = 1:length(reinforcement)
    ...
    divisive_norm = w(index).*gaussPro(-(stimnum-1)/2:(stimnum-1)/2, 1./(w(index))); % generalization to surrounding stimuli, width narrows with assoc strength, amplitide grows with associative strength
