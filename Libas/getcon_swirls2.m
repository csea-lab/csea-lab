...
function [rtvecsorted,RT,picundblockmat, errors, rtmeans] = getcon_swirls2(filemat);
...
a = 1;
 ...
 errors_201 = length(RT.rt_101(RT.rt_101 > 0))/length(RT.rt_101);
 errors_202 = length(RT.rt_102(RT.rt_102 > 0))/length(RT.rt_102);
 errors_203 = length(RT.rt_103(RT.rt_103 > 0))/length(RT.rt_103);
 errors_204 = length(RT.rt_104(RT.rt_104 > 0))/length(RT.rt_104);
 errors_205 = length(RT.rt_105(RT.rt_105 > 0))/length(RT.rt_105);
 errors_206 = length(RT.rt_106(RT.rt_106 > 0))/length(RT.rt_106);
 
 errors = [errors_201 errors_202 errors_203 errors_204 errors_205 errors_206]; 
 rtmeans = [mean(RT.rt_201) mean(RT.rt_202) mean(RT.rt_203) mean(RT.rt_204) mean(RT.rt_205) mean(RT.rt_206)]
