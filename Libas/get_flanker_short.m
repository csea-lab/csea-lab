function [all] = get_flanker_short(filename)
...
condition_vec_SOA
condition_vec_congruence

tempvec = (condition_vec_SOA .*2) + (condition_vec_congruence -1); 
outvec = zeros(121,1); 
outvec(2:2:121) = tempvec; 
outvec(3:2:121) = tempvec +10; 
