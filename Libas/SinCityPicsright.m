% filterpics
function [distmat] = SinCityPicsright(filemat, pixelpercentage); % pixelpercentage is a decimal ratio, e.g., .05
...
% take care of the left half for later
z = a(:,1:size(a,2)/2,:); 
...
% basic matrices for the right half

a = a(:,size(a,2)/2+1:size(a,2),:); 
...
color = 'red';
 ...
 % write result to file
  imwrite(I2both,[basename 'R.' color '.jpg' ], 'jpg')
...
color = 'green'; 
    ...
    pause(1)
      ...
      imwrite(I3both,[basename 'R.' color '.jpg' ], 'jpg')
