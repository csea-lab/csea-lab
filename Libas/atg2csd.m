function [CsdFileMat] = atg2csd(FileMat, Lambda, ECfgFile)
%	atg2csd
...
[NFiles,FileMat]=ReadFileNames(FileMat,'*.at*','Choose at. file(s) or batch file:');
...
for FileIndex=1:NFiles
	...
	%===========================================================================
        c0=mean(AvgMat);
		DataMat=AvgMat-(c0'*AllChanOnes)';
		DipStrength = InvCoeff \ DataMat;
		DataMat=(DipStrength' * CsdCoeff)';
		DataMat=DataMat+(c0'*AllChanOnes)';	
        
        SaveAvgFile([FilePath '.csd'],DataMat,NTrialAvgVec,StdChanTimeMat, ...
