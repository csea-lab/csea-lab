%divide_atg
function [diffmat] = divide_atg(filemat_1, filemat_2, outnamebase); 
...
for index = 1:size(filemat_1,1) 
 ...
 SaveAvgFile([outnamebase '_' num2str(index) '.atg.div.ar' ],diffmat,NTrialAvgVec,[],SampRate,MedMedRawVec,MedMedAvgVec,EegMegStatus); 
