...
function [conditionvec, condiPNU, accuracy] = getresponse_rdkNOAM_2018(filepath);
...
indices_correct_201 =  find(response_201 > 0.0 & correctvec(indices_201) == 1 & duringpiclabel(indices_201) ==1) ; meanRT_201 = mean(response_201(indices_correct_201))
indices_correct_202 =  find(response_202 > 0.0 & correctvec(indices_202) == 1 & duringpiclabel(indices_202) ==1) ; meanRT_202 = mean(response_202(indices_correct_202))
indices_correct_203 =  find(response_203 > 0.0 & correctvec(indices_203) == 1 & duringpiclabel(indices_203) ==1) ; meanRT_203 = mean(response_203(indices_correct_203))
indices_correct_204 =  find(response_204 > 0.0 & correctvec(indices_204) == 1 & duringpiclabel(indices_204) ==1) ; meanRT_204 = mean(response_204(indices_correct_204))
indices_correct_205 =  find(response_205 > 0.0 & correctvec(indices_205) == 1 & duringpiclabel(indices_205) ==1) ; meanRT_205 = mean(response_205(indices_correct_205))
indices_correct_206 =  find(response_206 > 0.0 & correctvec(indices_206) == 1 & duringpiclabel(indices_206) ==1) ; meanRT_206 = mean(response_206(indices_correct_206))
...
hits = [ hits_p hits_n hits_u]; 

accuracy = [accuracy_p accuracy_n accuracy_u]
