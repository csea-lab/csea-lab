function [source,sensFid,norm_elec, segmri] = beamform_as_cohere(cfgas, filemat, plotflag)
...
disp(cfgas.method)
 ...
 % save the source file
      if isstruct(filemat)
      eval(['save ' deblank(filemat(index).name) '.coh.mat source -mat']) 
      else
      eval(['save ' deblank(filemat(index,:)) '.coh.mat source -mat'])
      end
