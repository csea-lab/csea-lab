function [sourceIntPol, segmri] = beamform_allsteps(cfgas, data, plotflag)

% assumes that data have electrodes that are already lined up with the
% volume and that everything works smoothly ... use when running again,
% after segmentation and warping etc have been done separately
