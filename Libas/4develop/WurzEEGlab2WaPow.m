...
%    disp(['Loading file: ', filemat(index,:)])
   ...
   % now do three wavelet analyses
    wavelet_app_mat(double(temp.EEG_CerThreat.data), 500, 50, 300, 10, 72, [filemat(index,1:10) '.CerThreat']);
    wavelet_app_mat(double(temp.EEG_PoThreat.data), 500, 50, 300, 10, 72, [filemat(index,1:10) '.PoThreat']);
    wavelet_app_mat(double(temp.EEG_Safe.data), 500, 50, 300, 10, 72, [filemat(index,1:10) '.Safe']);
...
avgmats_mat(filemat3, 'GM49.pow3.app3.mat');
avgmats_mat(filemat2, 'GM49.pow3.app2.mat');
avgmats_mat(filemat1, 'GM49.pow3.app1.mat');

load('GM49.pow3.app1.mat')
avgmat1 = avgmat;
load('GM49.pow3.app2.mat')
avgmat2 = avgmat;
load('GM49.pow3.app3.mat')
avgmat3 = avgmat;
