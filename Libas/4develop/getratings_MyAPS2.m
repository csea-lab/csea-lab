function [outmat] = getratings_MyAPS2(filepath)
...
a = 1;
 ...
 while a > 0
    ...
    index11 = findstr(a, ' ');
    aro = [aro; str2num(a(index11(2):index11(3)))];
    val = [val; str2num(a(index11(3):index11(4)))];
 ...
 outmat = [singpicvec_num condvec4ERP val aro];
