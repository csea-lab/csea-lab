function [convector, hitrate] = getresponse_wmgabor2_2(filepath); 
...
indices_1 = find(a(:,3)==1); %no match
indices_2 = find(a(:,3)==2 | a(:,3)==3); %top match
indices_3 = find(a(:,3)==4 | a(:,3)==5); %bottom match
indices_4 = find(a(:,3)==6 | a(:,3)==7); %both match

convector(indices_1) = 1;
convector(indices_2) = 2;
convector(indices_3) = 3;
convector(indices_4) = 4;
convector = convector'; 
...
convector = convector*10 + correctvec
