...
% find the RTs for each condition - only correct responses
...
corrW_3 = length(index_neutWordCorrect)/15;
corrW_4 = length(index_lossWordCorrect)/15;
corrW_5 = length(index_threatWordCorrect)/15;
corrW_6 = length(index_mutilWordCorrect)/15;

wordscorrect = [corrW_1 corrW_2 corrW_3 corrW_4 corrW_5 corrW_6]

corrP_1 = length(index_eroP_wordCorrect)/15;
corrP_2 = length(index_famP_wordCorrect)/15;
corrP_3 = length(index_neutP_wordCorrect)/15;
corrP_4 = length(index_lossP_wordCorrect)/15;
corrP_5 = length(index_threatP_wordCorrect)/15;
corrP_6 = length(index_mutilP_wordCorrect)/15;

pseudowordscorrect = [corrP_1 corrP_2 corrP_3 corrP_4 corrP_5 corrP_6]
