...
function [output_all, rtmeansbyblock, errorsbyblock] = getcon_swirls3blocks(filemat);
...
a = 1;
 ...
 RT.rt_101 = condandRTmat(find(condandRTmat(:,1)==101),2);
 RT.rt_102 = condandRTmat(find(condandRTmat(:,1)==102),2);
 RT.rt_103 = condandRTmat(find(condandRTmat(:,1)==103),2);
 RT.rt_104 = condandRTmat(find(condandRTmat(:,1)==104),2);
 RT.rt_105 = condandRTmat(find(condandRTmat(:,1)==105),2);
 RT.rt_106 = condandRTmat(find(condandRTmat(:,1)==106),2);
 
 RT.rt_201 = condandRTmat(find(condandRTmat(:,1)==201),2);
 RT.rt_202 = condandRTmat(find(condandRTmat(:,1)==202),2);
 RT.rt_203 = condandRTmat(find(condandRTmat(:,1)==203),2);
 RT.rt_204 = condandRTmat(find(condandRTmat(:,1)==204),2);
 RT.rt_205 = condandRTmat(find(condandRTmat(:,1)==205),2);
 RT.rt_206 = condandRTmat(find(condandRTmat(:,1)==206),2);
...
for blocknum = 1:3
 ...
 RT.rt_101 = condandRTmat(find(condandRTmat(:,1)==101 & blockvec == blocknum),2);
 RT.rt_102 = condandRTmat(find(condandRTmat(:,1)==102 & blockvec == blocknum),2);
 RT.rt_103 = condandRTmat(find(condandRTmat(:,1)==103 & blockvec == blocknum),2);
 RT.rt_104 = condandRTmat(find(condandRTmat(:,1)==104 & blockvec == blocknum),2);
 RT.rt_105 = condandRTmat(find(condandRTmat(:,1)==105 & blockvec == blocknum),2);
 RT.rt_106 = condandRTmat(find(condandRTmat(:,1)==106 & blockvec == blocknum),2);
 
 RT.rt_201 = condandRTmat(find(condandRTmat(:,1)==201 & blockvec == blocknum),2);
 RT.rt_202 = condandRTmat(find(condandRTmat(:,1)==202 & blockvec == blocknum),2);
 RT.rt_203 = condandRTmat(find(condandRTmat(:,1)==203 & blockvec == blocknum),2);
 RT.rt_204 = condandRTmat(find(condandRTmat(:,1)==204 & blockvec == blocknum),2);
 RT.rt_205 = condandRTmat(find(condandRTmat(:,1)==205 & blockvec == blocknum),2);
 RT.rt_206 = condandRTmat(find(condandRTmat(:,1)==206 & blockvec == blocknum),2);
