...
function [expectvec11to14_3, valvect11to14_3] = getcon_condigazepilots(filemat);
 ...
 while a > 0
    ...
    if a > 0
        ...
        indexvec = findstr(a, ' ');% 
         ...
         trialvec = [trialvec str2num(a(indexvec(1):indexvec(2)))];
         blockvec = [blockvec str2num(a(indexvec(2)+1))];
         conditionvec = [conditionvec str2num(a(indexvec(4):indexvec(5)))];
        expectvec = [expectvec str2num(a(indexvec(5):indexvec(6)))];
        valvec = [valvec str2num(a(indexvec(6):indexvec(6)+1))];
        
    size(valvec) - size(expectvec)
