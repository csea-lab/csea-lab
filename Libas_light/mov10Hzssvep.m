function[fftamp, winmat3d,spectrum3d, targetbin, shiftmat, PLVshift] = mov10Hzssvep(inmat, outname)
...
plotflag = 1;  %0 = off, 1 = plot moving average
ssvepvec = 341:1341;  %window of the eeg data to analyze
